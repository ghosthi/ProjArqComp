...
architecture a_rom of rom is
    ...
    constant conteudo : mem := (
        ...
        13 => (B"000000000000_010_1101"), -- STORE r2           r2 <= A
        ...
        17 => (B"000000000000_000_1011"), -- LOAD zero;		    A <= zero = 0	    -- zera A 		
        18 => (B"000000000000_010_0110"), -- SW $r2;			MEM[$r2] <= A	-- zera registo r2 da mem	 (VOLTA BNE)


        19 => (B"000000000000_011_1011"), -- LOAD r3;		    A <= r3 = x	    -- passo da soma (multiplos sao de x em x)
        20 => (B"000000000000_010_0010"), -- ADD r2;			A += r2         -- soma o proximo multiplo
        21 => (B"000000000000_010_1101"), -- STORE r2;		    r2 <= A		    -- r2 = valor do proximo multiplo
        22 => (B"000000000000_010_1011"), -- LOAD $r2;			A <= r2	        -- valor do proximo multp
        23 => (B"000000000000_100_1101"), -- STORE r4;		    r4 <= A		    -- carrega valor de mem para comparar se já n acabou os numero na ram
        24 => (B"000000000000_001_1011"), -- LOAD r1;		    A <= r1 = 32    -- A <= 32
        25 => (B"000000000000_000_0000"), -- NOP DE teste
        26 => (B"111111111000_100_1100"), -- BNE r4,-8;                         -- se chegou em 32, volta -8 linhas

        27 => (B"000000000000_011_1011"), -- LOAD r3                            -- A <= r3 = x
        28 => (B"000000000000_101_0010"), -- ADD r5;                            -- A <= A + R5 (R5 = 1)
        29 => (B"111111101111_001_1100"), -- BNE r1, -17;                       -- SE A < 32
        ...
        --29 => (B"000000100001_001_1000"), -- LD r1, 33;		r1 <= 33
        --30 => (B"000000000000_011_1000"), -- LD r3, 0;	
        --31 => (B"000000000000_001_0011"), --LW $r1;			A <= MEM[$r1]   -- A <= MEM[32]
        --32 => (B"000000000000_011_1101"), --STORE r3;		r3 <= A		    -- r3 = A
        --33 => (B"000000000000_001_1011"), --LOAD r1;		A <= r1		    -- A = 32		
        --34 => (B"000000000000_000_0001"), --DEC;			A -= 1;		    -- A = 31
        --35 => (B"000000000000_001_1101"),  --STORE r1;		r1 <= A
        --36 => (B"111111111100_000_1100"), --BNE zero, -4; -- n iterou até 0
        others => (others=>'0')
    );
    begin 
